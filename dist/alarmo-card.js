...
/**
     ...
     */function Ie(e){return He(m(m({},e),{},{state:!0,attribute:!1}))}const Be="number";var Ve;!function(e){e.Disarmed="disarmed",e.Arming="arming",e.Pending="pending",e.Triggered="triggered",e.ArmedAway="armed_away",e.ArmedHome="armed_home",e.ArmedNight="armed_night",e.ArmedVacation="armed_vacation",e.ArmedCustomBypass="armed_custom_bypass"}(Ve||(Ve={}));const qe={[Ve.ArmedAway]:"hass:shield-lock",[Ve.ArmedHome]:"hass:shield-home",[Ve.ArmedNight]:"hass:shield-moon",[Ve.ArmedVacation]:"hass:shield-airplane",[Ve.ArmedCustomBypass]:"hass:security",[Ve.Disarmed]:"hass:shield-off",[Ve.Arming]:"hass:shield-outline",[Ve.Pending]:"hass:shield-outline",[Ve.Triggered]:"hass:bell-ring"};var Fe;!function(e){e.ArmAway="arm_away",e.ArmHome="arm_home",e.ArmNight="arm_night",e.ArmVacation="arm_vacation",e.ArmCustomBypass="arm_custom_bypass",e.Disarm="disarm"}(Fe||(Fe={}));const Ze={[Fe.ArmAway]:"mdi:lock",[Fe.ArmHome]:"mdi:home",[Fe.ArmNight]:"mdi:moon-waning-crescent",[Fe.ArmVacation]:"mdi:airplane",[Fe.ArmCustomBypass]:"mdi:shield",[Fe.Disarm]:"mdi:shield-off"},We={[Fe.ArmAway]:Ve.ArmedAway,[Fe.ArmHome]:Ve.ArmedHome,[Fe.ArmNight]:Ve.ArmedNight,[Fe.ArmVacation]:Ve.ArmedVacation,[Fe.ArmCustomBypass]:Ve.ArmedCustomBypass,[Fe.Disarm]:Ve.Disarmed};var Ge;!function(e){e.Disarm="disarm",e.Arm="arm",e.Trigger="trigger",e.FailedToArm="failed_to_arm",e.CommandNotAllowed="command_not_allowed",e.NoCodeProvided="no_code_provided",e.InvalidCodeProvided="invalid_code_provided",e.TriggerTimeExpired="trigger_time_expired",e.ReadyToArmModesChanged="ready_to_arm_modes_changed"}(Ge||(Ge={}));const Ke="alarmo_updated",Je=["arming","pending"],Ye={type:"",entity:"",name:"",keep_keypad_visible:!1,button_scale_actions:1,button_scale_keypad:1,states:{},show_messages:!0,show_ready_indicator:!0,show_bypassed_sensors:!0,use_code_dialog:!1,hide_keypad:!1,hide_arm_options:!1,pending_sound:"",click_sound:"",disarm_sound:""},Qe=2.5,Xe={skip_delay:!1,force:!1};var et;!function(e){e.Red="red",e.Pink="pink",e.Purple="purple",e.DeepPurple="deep-purple",e.Indigo="indigo",e.Blue="blue",e.LightBlue="light-blue",e.Cyan="cyan",e.Teal="teal",e.Green="green",e.LightGreen="light-green",e.Lime="lime",e.Yellow="yellow",e.Amber="amber",e.Orange="orange",e.DeepOrange="deep-orange",e.Brown="brown",e.LightGrey="light-grey",e.Grey="grey",e.DarkGrey="dark-grey",e.BlueGrey="blue-grey",e.Black="black",e.White="white"}(et||(et={}));var tt={heading:"Možnosti aktivace",skip_delay:"Přeskočit čas pro vystup",force:"Bypass otevřených senzorů"},it={keep_keypad_visible:"Zachovat klávesnici vždy viditelnou, i když není vyžadován žádný kód.",button_scale_actions:"Měřítko použité pro změnu velikosti tlačítek akcí.",button_scale_keypad:"Měřítko použité pro změnu velikosti tlačítek klávesnice.",show_messages:"Zobrazit diagnostické zprávy při spuštění alarmu nebo nemožnosti aktivace.",show_ready_indicator:"Zobrazit indikátor připraveno/nepřipraveno na tlačítkách režimu aktivace.",show_bypassed_sensors:"Zobrazit varování při aktivaci alarmu s přemostěnými senzory.",use_code_dialog:"Zobrazte klávesnici pro zadání kódu jako vyskakovací dialog.",hide_keypad:"Skrýt tlačítka klávesnice pro zadávání kódu.",available_actions:"Dostupné akce:",action_dialog:{title:"Upravit zobrazení akce '{action}'",show_button:{title:"Viditelnost akčního tlačítka",options:{always:"Vždy zobrazeno",never:"Nikdy zobrazeno",disarmed:"Zobrazit pouze při odzbrojení",armed:"Zobrazit pouze při zapnutí"}},button_label:"Přepsat popisek tlačítka",button_icon:"Ikona zobrazeného tlačítka",state_label:"Přepsat popisek stavu",color:"Přepsat barvu použitou pro akci"}},at={invalid_pin:"Neplatný",blocking_sensors:"Nelze aktivovat kvůli následujícím senzorům",triggered_sensors:"Alarm byl spuštěn následujícími senzory",bypassed_sensors:"Jsou tam přemostěné senzory"},ot={arm_options:tt,editor:it,errors:at},nt={heading:"Scharfschaltungsoptionen",skip_delay:"Ausgangsverzögerung überspringen",force:"Offene Sensoren ignorieren"},st={keep_keypad_visible:"Zeige das Pin-Eingabefeld immer an, auch wenn kein Code erfordert ist.",button_scale_actions:"Skalierungsfaktor für Buttongröße der Aktionen.",button_scale_keypad:"Skalierungsfaktor für Buttongröße der Pin-Eingabefeld.",show_messages:"Anzeige von Diagnosemeldungen, wenn der Alarm ausgelöst wird oder nicht scharf geschaltet werden kann.",show_ready_indicator:"Zeigt die Bereitschafts-/Nicht-Bereitschaftsanzeige auf den Scharfschaltmodus-Tasten an.",show_bypassed_sensors:"Warnung anzeigen, wenn der Alarm mit umgangenen Sensoren aktiviert wird.",use_code_dialog:"Zeigen Sie die Tastatur zur Codeeingabe als Popup-Dialog an.",hide_keypad:"Blenden Sie die Tasten der Tastatur zur Codeeingabe aus.",available_actions:"Verfügbare Aktionen:",action_dialog:{title:"Anzeige der Aktion '{action}' anpassen",show_button:{title:"Sichtbarkeit der Aktionsschaltfläche",options:{always:"Immer angezeigt",never:"Nie angezeigt",disarmed:"Nur im deaktivierten Zustand anzeigen",armed:"Nur im aktivierten Zustand anzeigen"}},button_label:"Überschreibung der Tastenbeschriftung",button_icon:"Angezeigtes Schaltflächensymbol",state_label:"Überschreibung der Statusbezeichnung",color:"Die für die Aktion verwendete Farbe überschreiben"}},rt={invalid_pin:"Ungültig",blocking_sensors:"Konnte nicht scharf geschaltet werden, da folgende Sensoren geöffnet sind",triggered_sensors:"Alarm wurde durch folgende Sensoren ausgelöst",bypassed_sensors:"Es gibt umgangene Sensoren"},lt={arm_options:nt,editor:st,errors:rt},dt={heading:"Επιλογές για όπλισμα",skip_delay:"Παράλειψη καθυστέρησης εξόδου",force:"Παράκαμψη ανοιχτών αισθητήρων"},ct={keep_keypad_visible:"Κράτησε το πληκτρολόγιο πάντα ορατό, ακόμη και όταν δεν απαιτείται εισαγωγή κωδικού.",button_scale_actions:"Συντελεστής κλίμακας για αλλαγή μεγέθους των κουμπιών ενεργειών.",button_scale_keypad:"Συντελεστής κλίμακας για αλλαγή μεγέθους των κουμπιών του πληκτρολογίου.",show_messages:"Εμφάνιση διαγνωστικών μηνυμάτων όταν ενεργοποιείται ο συναγερμός ή δεν μπορεί να οπλιστεί.",show_ready_indicator:"Εμφάνιση ένδειξης έτοιμο/μη έτοιμο στα κουμπιά λειτουργίας όπλισης.",show_bypassed_sensors:"Εμφάνιση προειδοποιητικού μηνύματος όταν ο συναγερμός οπλίζεται με παρακαμφθέντες αισθητήρες.",use_code_dialog:"Εμφανίστε το πληκτρολόγιο για την εισαγωγή του κωδικού ως αναδυόμενο παράθυρο διαλόγου.",hide_keypad:"Απόκρυψη των κουμπιών του πληκτρολογίου για την εισαγωγή του κωδικού.",available_actions:"Διαθέσιμες ενέργειες:",action_dialog:{title:"Προσαρμογή εμφάνισης της ενέργειας '{action}'",show_button:{title:"Ορατότητα κουμπιού ενέργειας",options:{always:"Εμφανίζεται πάντα",never:"Ποτέ δεν εμφανίζεται",disarmed:"Εμφάνιση μόνο όταν είναι αφοπλισμένο",armed:"Εμφάνιση μόνο όταν είναι οπλισμένο"}},button_icon:"Εμφανιζόμενο εικονίδιο κουμπιού",state_label:"Αντικατάσταση ετικέτας κατάστασης",color:"Παράκαμψη χρώματος που χρησιμοποιείται για την ενέργεια"}},ht={invalid_pin:"Ακυρος",blocking_sensors:"Δεν ήταν δυνατή η όπλιση λόγω των ακόλουθων αισθητήρων",triggered_sensors:"Ο συναγερμός ενεργοποιήθηκε από τους ακόλουθους αισθητήρες",bypassed_sensors:"Υπάρχουν παρακαμφθέντες αισθητήρες"},ut={arm_options:dt,editor:ct,errors:ht},pt={heading:"Options for arming",skip_delay:"Skip exit delay",force:"Bypass open sensors"},gt={keep_keypad_visible:"Keep the keypad always visible, also when no code input is required.",button_scale_actions:"Scaling factor to apply for resizing the action buttons.",button_scale_keypad:"Scaling factor to apply for resizing the keypad buttons.",show_messages:"Display diagnostic messages when alarm is triggered or cannot be armed.",show_ready_indicator:"Show ready/not ready indicator on arm mode buttons.",show_bypassed_sensors:"Show warning message when alarm is armed with bypassed sensors.",use_code_dialog:"Display the keypad for entering the code as a popup dialog.",hide_keypad:"Hide the keypad buttons for entering the code.",hide_arm_options:"Hide arm options menu.",pending_sound:"Set a url to a soundclip that should be played when alarm is pending.",click_sound:"Set a url to a soundclip that should be played when a button is pressed.",disarm_sound:"Set a url to a soundclip that should be played when the alarm is disarmed.",pending_sound_label:"Pending sound URL",click_sound_label:"Button press sound URL",disarm_sound_label:"Disarm sound URL",available_actions:"Available actions:",action_dialog:{title:"Customize display of action '{action}'",show_button:{title:"Button visibility",options:{always:"Always shown",never:"Never shown",disarmed:"Show only when disarmed",armed:"Hide only when disarmed"}},button_label:"Override displayed action label",button_icon:"Override displayed icon",state_label:"Override displayed state label",color:"Override color used for the action"}},_t={invalid_pin:"Invalid",blocking_sensors:"Could not arm due to the following sensors",triggered_sensors:"Alarm was triggered by the following sensors",bypassed_sensors:"There are bypassed sensors"},mt={arm_options:pt,editor:gt,errors:_t},vt={heading:"Opciones de armado",skip_delay:"Omitir el retardo de salida",force:"Pasar por alto los sensores abiertos"},ft={keep_keypad_visible:"Mantener el teclado siempre visible, también cuando no se requiere ninguna entrada de código.",button_scale_actions:"Factor de escalado para cambiar el tamaño de los botones de acción.",button_scale_keypad:"Factor de escalado para cambiar el tamaño de los botones del teclado.",show_messages:"Mostrar mensajes de diagnóstico cuando se activa la alarma o no se puede activar.",show_ready_indicator:"Mostrar indicador listo/no listo en los botones de modo armado.",show_bypassed_sensors:"Mostrar advertencia cuando la alarma está activada con sensores omitidos.",use_code_dialog:"Muestra el teclado para ingresar el código como un cuadro de diálogo emergente.",hide_keypad:"Ocultar los botones del teclado para ingresar el código.",available_actions:"Acciones disponibles:",action_dialog:{title:"Personalizar la visualización de la acción '{action}'",show_button:{title:"Visibilidad del botón de acción",options:{always:"Mostrar siempre",never:"Ocultar siempre",disarmed:"Mostrar solo si desarmada",armed:"Ocultar solo si desarmada"}},button_label:"Sobrescribir el texto del botón",button_icon:"Icono de botón mostrado",state_label:"Sobrescribir el texto de estado",color:"Anular el color utilizado para la acción"}},bt={invalid_pin:"Inválido",blocking_sensors:"No se pudo armar debido a los siguientes sensores",triggered_sensors:"La alarma fue disparada por los siguientes sensores",bypassed_sensors:"Hay sensores omitidos"},yt={arm_options:vt,editor:ft,errors:bt},kt={heading:"Options pour l'armement",skip_delay:"Ignorer le délai de sortie",force:"Bypasser les capteurs ouverts"},wt={keep_keypad_visible:"Gardez le clavier toujours visible, même lorsqu'aucune saisie de code n'est requise.",button_scale_actions:"Facteur d'échelle à appliquer pour le redimensionnement des boutons des actions.",button_scale_keypad:"Facteur d'échelle à appliquer pour le redimensionnement des boutons du clavier.",show_messages:"Afficher les messages de diagnostic lorsque l'alarme est déclenchée ou ne peut pas être armée.",show_ready_indicator:"Afficher l'indicateur prêt/pas prêt sur les boutons de mode d'armement.",show_bypassed_sensors:"Afficher un avertissement lorsque l'alarme est armée avec des capteurs ignorés.",use_code_dialog:"Affichez le clavier pour saisir le code sous forme de boîte de dialogue contextuelle.",hide_keypad:"Masquer les boutons du clavier pour saisir le code.",available_actions:"Actions disponibles:",action_dialog:{title:"Personnaliser l'affichage de l'action '{action}'",show_button:{title:"Visibilité du bouton d'action",options:{always:"Toujours affiché",never:"Jamais affiché",disarmed:"Afficher uniquement si désarmé",armed:"Afficher uniquement si armé"}},button_label:"Remplacer le libellé du bouton",button_icon:"Icône de bouton affichée",state_label:"Remplacer l'étiquette d'état",color:"Remplacer la couleur utilisée pour l'action"}},$t={invalid_pin:"Invalide",blocking_sensors:"Impossible d'armer en raison du(es) capteur(s) suivant(s)",triggered_sensors:"L'alarme a été déclenchée par le(s) capteur(s) suivant(s)",bypassed_sensors:"Il y a des capteurs ignorés"},xt={arm_options:kt,editor:wt,errors:$t},At={heading:"Opzioni di inserimento",skip_delay:"Ignorare il ritardo di uscita",force:"Ignorare i sensori aperti"},Ct={keep_keypad_visible:"Mantenere la tastiera sempre visibile, anche quando nessun codice è richiesto.",button_scale_actions:"Fattore di scala da applicare per ridimensionare i pulsanti di azione.",button_scale_keypad:"Fattore di scala da applicare per ridimensionare i pulsanti della tastiera.",show_messages:"Mostrare messaggi diagnostici quando l'allarme viene attivato o non può essere inserito.",show_ready_indicator:"Mostra l'indicatore pronto/non pronto sui pulsanti della modalità di inserimento.",show_bypassed_sensors:"Mostra avviso quando l'allarme è armato con sensori esclusi.",use_code_dialog:"Visualizza la tastiera per l'immissione del codice come finestra di dialogo popup.",hide_keypad:"Nascondi i pulsanti della tastiera per l'inserimento del codice.",available_actions:"Azioni disponibili:",action_dialog:{title:"Personalizzare la visualizzazione dell'azione '{action}'",show_button:{title:"Visibilità del pulsante di azione",options:{always:"Sempre visualizzato",never:"Mai visualizzato",disarmed:"Mostra solo quando disarmato",armed:"Mostra solo quando disarmato"}},button_label:"Sovrascrivere l'etichetta del pulsante",button_icon:"Icona del pulsante visualizzato",state_label:"Sovrascrivere l'etichetta di stato",color:"Sostituisci il colore utilizzato per l'azione"}},St={invalid_pin:"Non valido",blocking_sensors:"Impossibile inserire l'allarme a causa dei seguenti sensori",triggered_sensors:"L'allarme è stato attivato dai seguenti sensori",bypassed_sensors:"Sono presenti sensori esclusi"},Ot={arm_options:At,editor:Ct,errors:St},Et={heading:"Opties voor inschakelen",skip_delay:"Sla vertraging over",force:"Negeer open sensoren"},zt={keep_keypad_visible:"Houd het keypad altijd zichtbaar, ook wanneer er geen code vereist is.",button_scale_actions:"Schaalfactor actieknoppen",button_scale_keypad:"Schaalfactor keypadknoppen",show_messages:"Toon diagnostische berichten wanneer het alarm wordt geactiveerd of niet kan worden ingeschakeld.",show_ready_indicator:"Toon gereed/niet gereed-indicator op inschakelmodusknoppen.",show_bypassed_sensors:"Toon melding wanneer het alarm is ingeschakeld met omzeilde sensoren.",use_code_dialog:"Geef het toetsenbord voor het invoeren van de code weer als een pop-upvenster.",hide_keypad:"Verberg het toetsenbord voor het invoeren van de code.",available_actions:"Beschikbare acties:",action_dialog:{title:"Weergave van actie '{action}' aanpassen",show_button:{title:"Actieknop weergave",options:{always:"Altijd zichtbaar",never:"Nooit zichtbaar",disarmed:"Toon alleen bij uitgeschakeld",armed:"Zichtbaar tenzij uitgeschakeld"}},button_label:"Weergegeven naam voor actie",button_icon:"Weergegeven icoon voor actie",state_label:"Weergegeven status",color:"Weergegeven kleur voor action"}},jt={invalid_pin:"Ongeldig",blocking_sensors:"Kon niet inschakelen vanwege de volgende sensoren",triggered_sensors:"Alarm werd geactiveerd door de volgende sensoren",bypassed_sensors:"Er zijn omzeilde sensoren"},Pt={arm_options:Et,editor:zt,errors:jt},Tt={heading:"Opções para armar",skip_delay:"Omitir tempo para sair",force:"Ignorar os sensores abertos"},Lt={keep_keypad_visible:"Mantenha o teclado sempre visível, mesmo quando não for necessária nenhuma entrada de código.",button_scale_actions:"Fator de escala para redimensionar botões de ação.",button_scale_keypad:"Fator de escala para redimensionar os botões do teclado.",show_messages:"Mostrar mensagens de diagnóstico quando o alarme estiver disparado ou não puder ser armado.",show_ready_indicator:"Mostrar indicador de disponível/não disponível nos botões do modo de armar.",show_bypassed_sensors:"Mostrar aviso quando o alarme for ativado com sensores ignorados.",use_code_dialog:"Exiba o teclado para inserir o código como uma caixa de diálogo pop-up.",hide_keypad:"Oculte os botões do teclado para inserir o código.",available_actions:"Ações disponíveis:",action_dialog:{title:"Personalize a exibição da ação '{action}'",show_button:{title:"Visibilidade do botão de ação",options:{always:"Sempre visível",never:"Sempre visível",disarmed:"Mostrar somente quando desarmado",armed:"Mostrar somente quando armado"}},button_label:"Substituir texto do botão",button_icon:"Ícone de botão exibido",state_label:"Substituir texto de status",color:"Substituir a cor usada para a ação"}},Mt={invalid_pin:"Inválido",blocking_sensors:"Não foi possível armar devido aos seguintes sensores",triggered_sensors:"O alarme foi disparado pelos seguintes sensores",bypassed_sensors:"Existem sensores ignorados"},Nt={arm_options:Tt,editor:Lt,errors:Mt},Dt={heading:"Варианты постановки на охрану",skip_delay:"Задержка перед выходом",force:"Обход датчиков открытия"},Ut={keep_keypad_visible:"Клавиатура всегда видима, даже если ввод кода не требуется.",button_scale_actions:"Коэффициент масштабирования для изменения размера кнопок действий.",button_scale_keypad:"Коэффициент масштабирования для изменения размера кнопок клавиатуры.",show_messages:"Вывод диагностических сообщений, когда срабатывает сигнализация или ее невозможно включить.",show_ready_indicator:"Отображать индикатор готовности/неготовности на кнопках режима охраны.",show_bypassed_sensors:"Вывод предупреждающего сообщения, когда сигнализация включена с помощью обходных датчиков.",use_code_dialog:"Отобразить клавиатуру для ввода кода в виде всплывающего диалогового окна.",hide_keypad:"Скрыть кнопки клавиатуры для ввода кода.",available_actions:"Доступные действия:",action_dialog:{title:"Настройка отображения действия '{action}'",show_button:{title:"Видимость кнопки действия",options:{always:"Показывать всегда",never:"Показывать никогда",disarmed:"Показывать только при снятии с охраны",armed:"Показывать только при поддержании под охраной"}},button_label:"Измененение названия кнопки",button_icon:"Отображаемый значок кнопки",state_label:"Изменение названия состояния",color:"Переопределить цвет, используемый для действия"}},Rt={invalid_pin:"Неверный",blocking_sensors:"Не удалось включить охрану из-за следующих датчиков",triggered_sensors:"Сигнал тревоги был вызван следующими датчиками",bypassed_sensors:"Есть обходные датчики"},Ht={arm_options:Dt,editor:Ut,errors:Rt},It={heading:"Alternativ vid aktivering",skip_delay:"Hoppa över lämna fördröjning",force:"Förbikoppla öppna sensorer"},Bt={keep_keypad_visible:"Håll knappsatsen alltid synlig, även när ingen kodinmatning krävs.",button_scale_actions:"Ändra storlek på åtgärdsknapparna.",button_scale_keypad:"Ändra storlek på knapparna på knappsatsen.",show_messages:"Visa diagnostiska meddelanden när larmet utlöses eller inte kan aktiveras.",show_ready_indicator:"Visa redo/ej redo-indikator på lägesknapparna.",show_bypassed_sensors:"Visa varningsmeddelande när larmet är aktiverat med förbikopplade sensorer.",use_code_dialog:"Visa knappsatsen för att ange koden som en popup-dialogruta.",hide_keypad:"Dölj knapparna på tangentbordet för att ange koden.",available_actions:"Tillgängliga åtgärder:",action_dialog:{title:"Anpassa visningen av åtgärden '{action}'",show_button:{title:"Synlighet för åtgärdsknapp",options:{always:"Visas alltid",never:"Visas aldrig",disarmed:"Visa endast vid avaktivering",armed:"Visa endast vid aktivering"}},button_label:"Anpassad knappetikett",button_icon:"Visad knappikon",state_label:"Anpassad tillståndsetikett",color:"Åsidosättningsfärg som används för åtgärden"}},Vt={invalid_pin:"Ogiltig",blocking_sensors:"Kunde inte aktivera på grund av följande sensorer",triggered_sensors:"Larmet utlöstes av följande sensorer",bypassed_sensors:"Det finns förbikopplade sensorer"},qt={arm_options:It,editor:Bt,errors:Vt},Ft={heading:"警戒选项",skip_delay:"跳过离开延迟",force:"绕过开放的传感器"},Zt={keep_keypad_visible:"保持小键盘总是可见，即使不需要输入密码",button_scale_actions:"调整动作按键大小的缩放系数",button_scale_keypad:"调整小键盘按键大小的缩放系数",show_messages:"当警报被触发或无法警戒时，显示诊断信息。",show_ready_indicator:"在手臂模式按钮上显示就绪/未就绪指示器。",show_bypassed_sensors:"当警报配备旁路传感器时显示警告消息。",use_code_dialog:"以弹出对话框的形式显示用于输入代码的键盘。",hide_keypad:"隐藏用于输入代码的键盘按钮。",available_actions:"可用动作：",action_dialog:{title:"自定义动作'{action}'的显示",show_button:{title:"操作按钮可见性",options:{always:"始终显示",never:"从不显示",disarmed:"仅在解除武装时显示",armed:"仅在武装时显示"}},button_label:"覆盖按钮标签",button_icon:"显示的按钮图标",state_label:"覆盖状态标签",color:"覆盖操作使用的颜色"}},Wt={invalid_pin:"无效的",blocking_sensors:"由于以下传感器而无法警戒",triggered_sensors:"警报是由以下传感器触发的",bypassed_sensors:"有绕过的传感器"},Gt={arm_options:Ft,editor:Zt,errors:Wt},Kt={cs:Object.freeze({__proto__:null,arm_options:tt,default:ot,editor:it,errors:at}),de:Object.freeze({__proto__:null,arm_options:nt,default:lt,editor:st,errors:rt}),el:Object.freeze({__proto__:null,arm_options:dt,default:ut,editor:ct,errors:ht}),en:Object.freeze({__proto__:null,arm_options:pt,default:mt,editor:gt,errors:_t}),es:Object.freeze({__proto__:null,arm_options:vt,default:yt,editor:ft,errors:bt}),fr:Object.freeze({__proto__:null,arm_options:kt,default:xt,editor:wt,errors:$t}),it:Object.freeze({__proto__:null,arm_options:At,default:Ot,editor:Ct,errors:St}),nl:Object.freeze({__proto__:null,arm_options:Et,default:Pt,editor:zt,errors:jt}),"pt-BR":Object.freeze({__proto__:null,arm_options:Tt,default:Nt,editor:Lt,errors:Mt}),ru:Object.freeze({__proto__:null,arm_options:Dt,default:Ht,editor:Ut,errors:Rt}),sv:Object.freeze({__proto__:null,arm_options:It,default:qt,editor:Bt,errors:Vt}),"zh-Hans":Object.freeze({__proto__:null,arm_options:Ft,default:Gt,editor:Zt,errors:Wt})};function Jt(e,t,i="",a=""){const o=t.replace(/['"]+/g,"");var n;try{n=e.split(".").reduce(((e,t)=>e[t]),Kt[o])}catch(t){n=e.split(".").reduce(((e,t)=>e[t]),Kt.en)}if(void 0===n&&(n=e.split(".").reduce(((e,t)=>e[t]),Kt.en)),""!==i&&""!==a){Array.isArray(i)||(i=[i]),Array.isArray(a)||(a=[a]);for(let e=0;e<i.length;e++)n=n.replace(i[e],a[e])}return n}function Yt(e){return null!=e}function Qt(e){switch(typeof e){case"object":return 0==Object.keys(e).length;case"string":return 0==String(e).length;default:return!Yt(e)}}function Xt(e){return e.substring(0,e.indexOf("."))}const ei=(e,t)=>{let i={hide:!1};return(t.states||{}).hasOwnProperty(e)&&(i=Object.assign(Object.assign({},i),t.states[e])),i},ti=e=>{if(!e)return[];const t=e.attributes.supported_features||0;let i=[];return 2&t&&i.push(Fe.ArmAway),1&t&&i.push(Fe.ArmHome),4&t&&i.push(Fe.ArmNight),32&t&&i.push(Fe.ArmVacation),16&t&&i.push(Fe.ArmCustomBypass),i},ii=(e,t,i)=>{const a=Xt(e.entity_id),o=e.attributes.device_class,n=e.state;if(Object.values(Ve).includes(n)&&i){const e=ei(n,i);if(!Qt(e.state_label))return e.state_label}let s="";return o&&(s=t(`component.${a}.entity_component.${o}.state.${e.state}`)),s||(s=t(`component.${a}.entity_component._.state.${e.state}`)),s},ai=e=>null!==e.attributes.code_format,oi=(e,t,i=!1)=>{if(!e||!e.state)return"var(--state-unavailable-color)";let a=e.state;if(i){const i=Object.values(Fe).map((e=>We[e]));if(!i.includes(a)){const t=e.attributes.arm_mode;t&&(a=t)}const o=[Fe.Disarm,...ti(e)].filter((e=>!ei(We[e],t).hide));1==o.length&&(a=We[o[0]])}if(Object.keys(t.states||{}).includes(a)&&Yt((t.states[a]||{}).color)){const e=t.states[a].color;return Object.values(et).includes(e)?`var(--${e}-color)`:e}return a==Ve.Disarmed?"var(--state-alarm_control_panel-disarmed-color, var(--state-alarm_control_panel-inactive-color, var(--state-inactive-color)))":Object.values(Ve).includes(a)?`var(--state-alarm_control_panel-${a}-color, var(--state-alarm_control_panel-active-color, var(--state-active-color)))`:"var(--disabled-color, var(--state-inactive-color))"},ni=e=>e.callWS({type:"alarmo/entities"}),si=e=>e.callWS({type:"alarmo/config"}),ri=(e,t,i,a)=>{a=a||{},i=null==i?{}:i;const o=new Event(t,{bubbles:void 0===a.bubbles||a.bubbles,cancelable:Boolean(a.cancelable),composed:void 0===a.composed||a.composed});return o.detail=i,e.dispatchEvent(o),o};let li=class extends Me{constructor(){super(...arguments),this._entities=null,this._editAction=null}async firstUpdated(){ni(this.hass).then((e=>{this._entities=e.map((e=>e.entity_id))})).catch((e=>{var t;null===(t=this.hass)||void 0===t||t.callService("system_log","write",{message:`Failed to fetch entities: ${e}`,level:"error"})})),this._alarmoConfig=await si(this.hass)}setConfig(e){!(null==e?void 0:e.button_scale_actions)&&(null==e?void 0:e.button_scale)&&(e=Object.assign(Object.assign({},e),{button_scale_actions:null==e?void 0:e.button_scale})),!(null==e?void 0:e.button_scale_keypad)&&(null==e?void 0:e.button_scale)&&(e=Object.assign(Object.assign({},e),{button_scale_keypad:null==e?void 0:e.button_scale})),this._config=Object.assign(Object.assign({},Ye),e)}render(){var e,t,i,a,o,n,s,r;if(!this._config||!this.hass||!this._entities)return ve``;if(!this._entities.length)return ve`
      ...
      `;const l=this._config.entity?this.hass.states[this._config.entity]:void 0,d=(null===(e=this._alarmoConfig)||void 0===e?void 0:e.code_format)===Be&&(this._alarmoConfig.code_arm_required||this._alarmoConfig.code_disarm_required);if(null!==this._editAction){const e=ei(We[this._editAction],this._config);return ve`
        ...
        <div>
          <span>${Jt("editor.action_dialog.show_button.title",this.hass.language)}</span>
          <div style="display: flex; flex-direction: row">
            <ha-formfield label="${Jt("editor.action_dialog.show_button.options.always",this.hass.language)}">
              <ha-radio
                name="show_button"
                value="never"
                @change=${()=>this._updateStateConfig(We[this._editAction],{hide:void 0})}
                ?checked=${!Yt(e.hide)||[!1,"never"].includes(e.hide)}
              >
              </ha-radio>
            </ha-formfield>

            <ha-formfield label="${Jt("editor.action_dialog.show_button.options.never",this.hass.language)}">
              <ha-radio
                name="show_button"
                value="always"
            ...
            ${this._editAction==Fe.Disarm?ve`
            <ha-formfield label="${Jt("editor.action_dialog.show_button.options.armed",this.hass.language)}">
              <ha-radio
                name="show_button"
                value="disarmed"
            ...
            <ha-formfield label="${Jt("editor.action_dialog.show_button.options.disarmed",this.hass.language)}">
              <ha-radio
                name="show_button"
                value="armed"
        ...
        <div class="grid">
          ...
          <ha-select
            .icon=${Yt(e.color)}
            label="${Jt("editor.action_dialog.color",this.hass.language)}"
            .value=${e.color}
          ...
          ${e.color?ve`
            ...
            `:be}
            ${Yt(e.color)&&e.color.length&&!Object.values(et).includes(e.color)?ve`
      ...
      <div class="card-config">
        ...
        <div class="grid">
          ...
          <ha-formfield .label=${Jt("editor.hide_arm_options",this.hass.language)}>
            <ha-switch
          ...
          <ha-input
            class="wide"
            .label="${Jt("editor.pending_sound_label",this.hass.language)} (${this.hass.localize("ui.panel.lovelace.editor.card.config.optional")})"
            .helper="${Jt("editor.pending_sound",this.hass.language)}"
            helperPersistent
          ...
          <ha-input
            class="wide"
            .label="${Jt("editor.click_sound_label",this.hass.language)} (${this.hass.localize("ui.panel.lovelace.editor.card.config.optional")})"
            .helper="${Jt("editor.click_sound",this.hass.language)}"
            helperPersistent
          ...
          <ha-input
            class="wide"
            .label="${Jt("editor.disarm_sound_label",this.hass.language)} (${this.hass.localize("ui.panel.lovelace.editor.card.config.optional")})"
            .helper="${Jt("editor.disarm_sound",this.hass.language)}"
            helperPersistent
            .value="${this._config.disarm_sound||""}"
            @input=${e=>this._updateConfig("disarm_sound",String(e.target.value).trim())}
          ></ha-input>

          <ha-formfield></ha-formfield>
        </div>
      </div>
    `}_renderActionOptions(){if(!this._config||!this.hass||!this._config.entity)return be;const e=this.hass.states[this._config.entity],t=ti(e);let i=[Fe.Disarm,...t].map((e=>({id:e,label:this.hass.localize(`ui.card.alarm_control_panel.${e}`),hidden:["always",!0].includes(ei(We[e],this._config).hide||!1),order:ei(We[e],this._config).button_order})));return i.sort(((e,t)=>e.hidden&&!t.hidden?1:t.hidden&&!e.hidden?-1:Yt(e.order)||Yt(t.order)?Yt(e.order)&&!Yt(t.order)?-1:!Yt(e.order)&&Yt(t.order)?1:e.order-t.order:0)),ve`
      <ha-sortable
        ...
        ${i.map(((e,t)=>ve`
          <div class="sortable-item ${e.hidden?"":"draggable"}"">
            ...
            <ha-icon-button
              ...
              ?disabled=${!e.hidden&&i.filter((e=>!e.hidden)).length<=2||e.id==Fe.Disarm}
    ...
    `}}t([He()],ui.prototype,"hass",void 0),t([He()],ui.prototype,"entity",void 0),t([Ie()],ui.prototype,"_hover",void 0),customElements.define("alarmo-state-badge",ui),function(e){e.language="language",e.system="system",e.comma_decimal="comma_decimal",e.decimal_comma="decimal_comma",e.space_comma="space_comma",e.none="none"}(di||(di={})),function(e){e.language="language",e.system="system",e.am_pm="12",e.twenty_four="24"}(ci||(ci={}));class pi extends Me{shouldUpdate(e){const t=e.get("hass");return!t||!(!this.entity||t.states[this.entity]===this.hass.states[this.entity])}render(){if(!this.hass||!this.entity)return ve``;const e=this.entity in this.hass.states;let t=Object.assign({},this.hass.states[this.entity]);void 0!==this.state&&(t=Object.assign(Object.assign({},t),{state:this.state}));const i=e?ii(t,this.hass.localize):this.hass.localize("state.default.unavailable",this.hass.locale||{language:this.hass.language,number_format:di.language}),a=e?t.attributes.friendly_name||(o=t.entity_id).substring(o.indexOf(".")+1):this.entity;var o;let n=!!this.state||"on"==t.state;return ve`
    ...
    `}}t([He()],pi.prototype,"hass",void 0),t([He()],pi.prototype,"entity",void 0),t([He()],pi.prototype,"state",void 0),customElements.define("alarmo-sensor-badge",pi);class gi extends Me{constructor(){super(...arguments),this.disabled=!1,this.scaled=!1}render(){return ve`
    ...
    `}}t([He({type:Boolean})],gi.prototype,"disabled",void 0),t([He({type:Boolean})],gi.prototype,"scaled",void 0),customElements.define("alarmo-button",gi);const _i=e=>{class i extends e{connectedCallback(){super.connectedCallback(),this.__checkSubscribed()}disconnectedCallback(){if(super.disconnectedCallback(),this.__unsubs){for(;this.__unsubs.length;){const e=this.__unsubs.pop();e instanceof Promise?e.then((e=>e())):e()}this.__unsubs=void 0}}updated(e){super.updated(e),e.has("hass")&&this.__checkSubscribed()}hassSubscribe(){return[]}__checkSubscribed(){void 0===this.__unsubs&&this.isConnected&&void 0!==this.hass&&(this.__unsubs=this.hassSubscribe())}}return t([He({attribute:!1})],i.prototype,"hass",void 0),i},mi=["1","2","3","4","5","6","7","8","9","0","clear","submit"];let vi=class extends(_i(Me)){constructor(){super(...arguments),this._input="",this._showClearButton=!1,this._narrow=!1,this._codeClearTimer=0}hassSubscribe(){return[this.hass.connection.subscribeMessage((e=>this._fetchData(e)),{type:Ke})]}async _fetchData(e){var t;if(e.data.area_id===(null===(t=this._params)||void 0===t?void 0:t.area_id))switch(e.data.event){case Ge.Disarm:case Ge.Arm:case Ge.Trigger:this._confirm(e.data.event);break;case Ge.InvalidCodeProvided:case Ge.NoCodeProvided:this._showCodeError();break;case Ge.FailedToArm:case Ge.CommandNotAllowed:this._confirm(e.data.event);case Ge.TriggerTimeExpired:case Ge.ReadyToArmModesChanged:}}shouldUpdate(e){const t=e.get("hass");return!(!e.has("_params")&&this._params)||(!!e.has("_input")||(!t||t.states[this._params.entity_id]!==this.hass.states[this._params.entity_id]&&(t.states[this._params.entity_id],this.hass.states[this._params.entity_id],!0)))}firstUpdated(e){super.firstUpdated(e),this.addEventListener("keypress",(e=>{"Enter"===e.key&&this._input.length&&this._submit()}))}async showDialog(e){this._params=e,this._input="",this._narrow=matchMedia("all and (max-width: 450px), all and (max-height: 500px)").matches,await this.updateComplete}closeDialog(){return this._params=void 0,this._showClearButton=!1,!0}_showCodeError(){var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("#code");t&&(t.classList.remove("error"),t.classList.add("error"),t.hint=Jt("errors.invalid_pin",this.hass.language))}_clearCodeError(){var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("#code");t&&t.classList.contains("error")&&(t.classList.remove("error"),t.hint="",this._input="",this._cancelCodeClearTimer())}_clearCode(){this._input="",this._clearCodeError(),this._cancelCodeClearTimer()}_setCodeClearTimer(){this._cancelCodeClearTimer(),this._input.length&&(this._codeClearTimer=window.setTimeout((()=>{this._clearCode()}),12e4))}_cancelCodeClearTimer(){this._codeClearTimer&&clearTimeout(this._codeClearTimer)}_submit(){var e;const t=null!==(e=this._input)&&void 0!==e?e:"";this._clearCodeError(),this._params.action==Fe.Disarm?this.hass.callService("alarmo","disarm",{entity_id:this._params.entity_id,code:t}):this.hass.callService("alarmo","arm",Object.assign(Object.assign({},this._params.armOptions),{entity_id:this._params.entity_id,mode:We[this._params.action],code:t}))}_confirm(e){var t,i;null===(i=null===(t=this._params)||void 0===t?void 0:t.confirm)||void 0===i||i.call(t,e),this.closeDialog()}_cancel(){var e,t;null===(t=null===(e=this._params)||void 0===e?void 0:e.cancel)||void 0===t||t.call(e),this.closeDialog()}_numberClick(e){const t=e.currentTarget.value;this._clearCodeError(),this._setCodeClearTimer(),this._input=this._input+t,this._showClearButton=!0}_clear(){this._input="",this._showClearButton=!1}render(){if(!this._params||!this.hass)return be;return"text"===this._params.code_format?ve`
      ...
      >
        <div class="container">
          ...
          ></ha-input>
          <div class="keypad">
            ${mi.map((e=>""===e?ve`<span></span>`:"clear"===e?ve`
                      <ha-control-button
                        @click=${this._clear}
                        class="clear"
  ...
  `,t([He({attribute:!1})],vi.prototype,"hass",void 0),t([Ie()],vi.prototype,"_params",void 0),t([Ie()],vi.prototype,"_input",void 0),t([Ie()],vi.prototype,"_showClearButton",void 0),t([Ie()],vi.prototype,"_narrow",void 0),vi=t([De("alarmo-code-dialog")],vi);var fi=Object.freeze({__proto__:null,get AlarmoCodeDialog(){return vi}});let bi=class extends Me{render(){if(!this.hass||!this.config)return be;const e=this.hass.states[this.config.entity];let t=e.state;const i=Object.values(Fe).map((e=>We[e]));if(!i.includes(t)){const i=e.attributes.arm_mode;i&&(t=i)}return ve`
      <div class="container">
        ${this._renderOptions(t)}
      </div>
    `}_renderOptions(e){const t=this.hass.states[this.config.entity],i=[Fe.Disarm,...ti(t)].filter((e=>{const i=ei(We[e],this.config).hide;if("boolean"==typeof i||!Yt(i))return!i;switch(i){case"always":return!1;case"never":return!0;case"armed":return"disarmed"==t.state;case"disarmed":return"disarmed"!==t.state}})),a=i.map((e=>ei(We[e],this.config))).some((e=>!Yt(e.button_label)||e.button_label.length));return i.sort(((e,t)=>{const i=ei(We[e],this.config).button_order,a=ei(We[t],this.config).button_order;return Yt(i)||Yt(a)?Yt(i)&&!Yt(a)?-1:!Yt(i)&&Yt(a)?1:i-a:0})),i.map((i=>{const o=Yt(this.readyForArmModes)&&!this.readyForArmModes.includes(We[i])&&i!=Fe.Disarm,n=ei(We[i],this.config);return ve`
        <div class="button ${We[i]==e?"selected":""}" @click=${e=>this._handleClick(e,i)}>
          <div class="content ${a?"has-text":""}">
            <ha-icon icon="${Qt(n.button_icon)?Ze[i]:n.button_icon}"></ha-icon>
            ${We[i]!=e&&Yt(this.readyForArmModes)?ve`
              <ha-icon
            ...
            `:be}
            <span>
              ${Yt(n.button_label)?n.button_label:i==Fe.Disarm&&t.state!==Ve.Disarmed?this.hass.localize(`ui.card.alarm_control_panel.${i}`):this.hass.localize(`ui.card.alarm_control_panel.modes.${We[i]}`)}
            </span>
          </div>
        </div>
      `}))}_handleClick(e,t){ri(this,"button-clicked",{ev:e,action:t})}static get styles(){return L`
      :host {
        width: 100%;
        display: inline-block;
        padding: 0px 10px;
    ...
    `}};t([He({attribute:!1})],bi.prototype,"hass",void 0),t([He({attribute:!1})],bi.prototype,"config",void 0),t([He({attribute:!1})],bi.prototype,"readyForArmModes",void 0),bi=t([De("alarmo-actions-bar")],bi);class yi{constructor(e){this.hasSoundUrl=!!e,this.hasSoundUrl&&(this.audio=new Audio(e),this.audio.loop=!0,this.audio.preload="auto",this.audio.load())}set hass(e){const t=this._hass;this._hass=e,this.hassChanged(t)}set entity(e){this._entity=e}hassChanged(e){if(this._hass&&this._entity)if(e&&e.themes===this._hass.themes&&e.language===this._hass.language){if(e.states[this._entity].state!==this._hass.states[this._entity].state||e.states[this._entity].attributes.delay!==this._hass.states[this._entity].attributes.delay){const t=e.states[this._entity].state,i=this._hass.states[this._entity].state;Je.includes(i)?this.playSound():Je.includes(t)&&this.stopSound(),this.updateAudio()}}else this.updateAudio()}updateAudio(){if(this._hass&&this._entity){const e=this._hass.states[this._entity].state;Je.includes(e)&&this.playSound()}}async playSound(){if(this.hasSoundUrl&&this.audio&&this.audio.paused)try{await this.audio.play()}catch(e){console.error("Error playing audio:",e)}}pauseSound(){this.hasSoundUrl&&this.audio&&this.audio.pause()}stopSound(){this.hasSoundUrl&&this.audio&&(this.audio.pause(),this.audio.currentTime=0)}}class ki{constructor(e){e&&(this.audio=new Audio(e),this.audio.preload="auto",this.audio.load())}async play(){if(this.audio)try{this.audio.currentTime=0,await this.audio.play()}catch(e){console.error("Error playing click sound:",e)}}}const wi=["1","2","3","4","5","6","7","8","9","","0","clear"];return e.AlarmoCard=class extends(_i(Me)){constructor(){super(...arguments),this._input="",this.warning="",this.area_id=void 0,this.armOptions=Object.assign({},Xe),this.readyForArmModes=null,this.backendConnection=null,this.showBypassedSensors=!1,this._menuOpen=!1,this.subscribedEntities=[],this._codeClearTimer=0,this._pendingDuckTimer=0,this._boundCloseMenu=this._closeMenu.bind(this)}static async getConfigElement(){return await Promise.resolve().then((function(){return hi})),document.createElement("alarmo-card-editor")}static async getStubConfig(e){let t=Object.keys(e.states).find((e=>"alarm_control_panel"==Xt(e)));return await ni(e).then((e=>{const i=e.sort(((e,t)=>Number(e.area_id)-Number(t.area_id)));i.length&&(t=i[0].entity_id)})),{type:"custom:alarmo-card",entity:t}}async getCardSize(){var e;if(!this._config||!this.hass)return 9;const t=this.hass.states[this._config.entity];return t&&(null===(e=this._alarmoConfig)||void 0===e?void 0:e.code_format)===Be?!ai(t)&&!this._config.keep_keypad_visible||this._config.use_code_dialog?4:9:4}setConfig(e){!(null==e?void 0:e.button_scale_actions)&&(null==e?void 0:e.button_scale)&&(e=Object.assign(Object.assign({},e),{button_scale_actions:null==e?void 0:e.button_scale})),!(null==e?void 0:e.button_scale_keypad)&&(null==e?void 0:e.button_scale)&&(e=Object.assign(Object.assign({},e),{button_scale_keypad:null==e?void 0:e.button_scale})),(e=>{if(!e||!e.entity||"alarm_control_panel"!==Xt(e.entity))throw new Error("Invalid configuration provided for entity");if(Yt(e.button_scale_keypad)&&("number"!=typeof e.button_scale_keypad||e.button_scale_keypad<1||e.button_scale_keypad>Qe))throw new Error("Invalid configuration provided for button_scale_keypad");if(Yt(e.button_scale_actions)&&("number"!=typeof e.button_scale_actions||e.button_scale_actions<1||e.button_scale_actions>Qe))throw new Error("Invalid configuration provided for button_scale_actions")})(e),this._config=Object.assign(Object.assign({},Ye),e)}hassSubscribe(){return[this.hass.connection.subscribeMessage((e=>this._fetchData(e)),{type:Ke})]}initSounds(){this._config&&this.hass&&(this.pendingSound=new yi(this._config.pending_sound),this.clickSound=new ki(this._config.click_sound),this.disarmSound=new ki(this._config.disarm_sound),(this._config.pending_sound||this._config.click_sound||this._config.disarm_sound)&&console.debug(`alarmo-card: sounds initialised (pending: ${this._config.pending_sound||"none"}, click: ${this._config.click_sound||"none"}, disarm: ${this._config.disarm_sound||"none"})`),this._resumePendingSound())}async firstUpdated(){this.initSounds();const e=await window.loadCardHelpers(),t=await e.createCardElement({type:"entities",entities:[]});await t.constructor.getConfigElement(),await this.loadBackendConfig()}async loadBackendConfig(){this.backendConnection||ni(this.hass).then((e=>{const t=e.find((e=>e.entity_id==this._config.entity));t&&(this.area_id=t.area_id?t.area_id:null)})).then((()=>si(this.hass))).then((e=>{this._alarmoConfig=e,this.backendConnection=!0})).then((()=>{return e=this.hass,t=this._config.entity,e.callWS({type:"alarmo/ready_to_arm_modes",entity_id:t});var e,t})).then((e=>{this.readyForArmModes=e.modes})).catch((e=>{this.backendConnection=!1}))}async _fetchData(e){if(e.data.area_id===this.area_id)switch(e.data.event){case Ge.Arm:this._clearCode();break;case Ge.Trigger:break;case Ge.InvalidCodeProvided:case Ge.NoCodeProvided:this._showCodeError(),this.subscribedEntities=[];break;case Ge.FailedToArm:this.warning="blocking_sensors",this._last_command=e.data.command,this._last_code=this._input,this._clearCode();break;case Ge.CommandNotAllowed:this._clearCode();break;case Ge.TriggerTimeExpired:break;case Ge.ReadyToArmModesChanged:this.readyForArmModes=e.data.modes}}shouldUpdate(e){if(e.has("_config"))return!0;const t=e.get("hass");if(!t||t.themes!==this.hass.themes||t.language!==this.hass.language||t.config.state!==this.hass.config.state)return!0;if(t.states[this._config.entity]!==this.hass.states[this._config.entity]){const e=t.states[this._config.entity],i=this.hass.states[this._config.entity];return!1===this.backendConnection&&(async()=>{await this.loadBackendConfig()})(),this.processStateUpdate(e,i),!0}return!(!this.subscribedEntities.length||!this.subscribedEntities.some((e=>t.states[e]!==this.hass.states[e])))}processStateUpdate(e,t){var i,a,o;t.state!=e.state&&(this.subscribedEntities=[],this._cancelPendingDuck(),null===(i=this.pendingSound)||void 0===i||i.stopSound()),t.state==Ve.Disarmed?(e.state!=Ve.Disarmed&&(null===(a=this.disarmSound)||void 0===a||a.play()),this._clearCode()):t.last_changed!==e.last_changed&&this._clearCode(),t.state!=Ve.Pending&&t.state!=Ve.Arming||null===(o=this.pendingSound)||void 0===o||o.playSound()}render(){var e,t;if(!this._config||!this.hass||null===this.backendConnection)return ve``;const i=this.hass.states[this._config.entity];return i?!1===this.backendConnection?ve`
        <hui-warning>
      ...
      `:ve`
      <ha-card>
        ${i.state!==Ve.Disarmed||this._config.hide_arm_options?"":ve`
        ...
        <div class="header">
          <div class="icon">
            <alarmo-state-badge
              ...
              style="--alarm-state-color: ${oi(i,this._config)}"
            >
            </alarmo-state-badge>
          </div>
          <div class="summary">
        ...
        ${!ai(i)&&!this._config.keep_keypad_visible||this._config.use_code_dialog?ve``:ve`
              <ha-input
                .value=${this._input}
              ...
              ></ha-input>
            `}
        ${!ai(i)&&!this._config.keep_keypad_visible||(null===(t=this._alarmoConfig)||void 0===t?void 0:t.code_format)!==Be||this._config.use_code_dialog||this._config.hide_keypad?ve``:ve`
          <div id="keypad" class="keypad" style="max-width: ${300*this._config.button_scale_keypad}px">
            ...
            `:ve`
              <alarmo-button
                ...
                ?disabled=${!ai(i)||"clear"===e&&!this._input.length}
                class="${"clear"!==e?"numberKey":"clear"}"
                style="--content-scale: ${this._config.button_scale_keypad}"
                ?scaled=${1!=this._config.button_scale_keypad}
              >
                ${"clear"===e?ve`<ha-icon icon="mdi:close" style="--mdc-icon-size: calc(${this._config.button_scale_keypad} * 24px)"></ha-icon>`:ve` <span>${e}</span>`}
              </alarmo-button>
            `))}
          </div>
        `}
    ...
    `:ve`
      ...
      `}_renderActions(){if(!this.hass||!this._config)return ve``;const e=this.hass.states[this._config.entity],t=this._config.show_ready_indicator;return ve`
      <alarmo-actions-bar
        @button-clicked=${e=>this._handleActionClick(e,e.detail.action)}
        .hass=${this.hass}
        .config=${this._config}
        .readyForArmModes=${t?this.readyForArmModes:void 0}
        style="--alarm-state-color: ${oi(e,this._config,!0)}; --content-scale: ${this._config.button_scale_actions}"
      ></alarmo-actions-bar>
    `}_renderWarning(){var e;if(!this.hass||!this._config||!this._config.show_messages)return ve``;const t=this.hass.states[this._config.entity];return t.attributes.open_sensors&&t.state==Ve.Triggered||"blocking_sensors"==this.warning&&t.attributes.open_sensors?ve`
      ...
      `:ve``}_handlePadClick(e){var t;null===(t=this.clickSound)||void 0===t||t.play(),this._duckPendingSound();const i=e.currentTarget.value;this._clearCodeError(),this._input="clear"===i?"":this._input+i}async _handleActionClick(e,t){var i,a;null===(i=this.clickSound)||void 0===i||i.play(),this._duckPendingSound(),e.target.blur(),this._clearCodeError();const o=this.hass.states[this._config.entity];if((null===(a=this._config)||void 0===a?void 0:a.use_code_dialog)&&!this._config.hide_keypad&&ai(o)){const i=await new Promise((i=>{const a=e.target,o={code_format:this._alarmoConfig.code_format,area_id:this.area_id,entity_id:this._config.entity,action:t,armOptions:this.armOptions,cancel:()=>{i(null)},confirm:e=>{i(e)}};ri(a,"show-dialog",{dialogTag:"alarmo-code-dialog",dialogImport:()=>Promise.resolve().then((function(){return fi})),dialogParams:o})}));i!=Ge.Arm&&i!=Ge.Disarm||(this.warning="",this.armOptions=Object.assign({},Xe))}else t==Fe.Disarm?this.hass.callService("alarmo","disarm",{entity_id:this._config.entity,code:this._input}):this.hass.callService("alarmo","arm",Object.assign(Object.assign({},this.armOptions),{entity_id:this._config.entity,mode:We[t],code:this._input})),this.warning="",this.armOptions=Object.assign({},Xe)}_resumePendingSound(){var e,t,i;const a=this._config?null===(t=null===(e=this.hass)||void 0===e?void 0:e.states[this._config.entity])||void 0===t?void 0:t.state:void 0;a&&Je.includes(a)&&(null===(i=this.pendingSound)||void 0===i||i.playSound())}_duckPendingSound(){var e,t,i,a,o;if(!(null===(e=this._config)||void 0===e?void 0:e.pending_sound)||!(null===(t=this._config)||void 0===t?void 0:t.click_sound))return;const n=null===(a=null===(i=this.hass)||void 0===i?void 0:i.states[this._config.entity])||void 0===a?void 0:a.state;n&&Je.includes(n)&&(null===(o=this.pendingSound)||void 0===o||o.pauseSound(),clearTimeout(this._pendingDuckTimer),this._pendingDuckTimer=window.setTimeout((()=>{var e,t,i;this._pendingDuckTimer=0;const a=null===(t=null===(e=this.hass)||void 0===e?void 0:e.states[this._config.entity])||void 0===t?void 0:t.state;a&&Je.includes(a)&&(null===(i=this.pendingSound)||void 0===i||i.playSound())}),1e3))}_cancelPendingDuck(){clearTimeout(this._pendingDuckTimer),this._pendingDuckTimer=0}_showCodeError(){var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("#code_input");t&&(t.classList.remove("error"),t.classList.add("error"),t.hint=Jt("errors.invalid_pin",this.hass.language))}_clearCodeError(){var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("#code_input");t&&t.classList.contains("error")&&(t.classList.remove("error"),t.hint="",this._input="",this._cancelCodeClearTimer())}_clearCode(){this._input="",this._clearCodeError(),this._cancelCodeClearTimer()}_setCodeClearTimer(){this._cancelCodeClearTimer(),this._input.length&&(this._codeClearTimer=window.setTimeout((()=>{this._clearCode()}),12e4))}_cancelCodeClearTimer(){this._codeClearTimer&&clearTimeout(this._codeClearTimer)}_toggleArmOptions(e,t){e.stopImmediatePropagation(),e.target.blur(),"skip_delay"==t?this.armOptions=Object.assign(Object.assign({},this.armOptions),{skip_delay:!this.armOptions.skip_delay}):"force"==t&&(this.armOptions=Object.assign(Object.assign({},this.armOptions),{force:!this.armOptions.force}))}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._boundCloseMenu),this._resumePendingSound()}disconnectedCallback(){var e;super.disconnectedCallback(),document.removeEventListener("click",this._boundCloseMenu),this._cancelPendingDuck(),null===(e=this.pendingSound)||void 0===e||e.stopSound()}_toggleMenu(e){e.stopPropagation(),this._menuOpen=!this._menuOpen}_closeMenu(){this._menuOpen&&(this._menuOpen=!1)}_forceRetryClick(){if(!this.hass||!this._config||!this._last_command)return;let e=this._last_command;this.hass.callService("alarmo","arm",{entity_id:this._config.entity,mode:We[e],code:this._last_code,force:!0}),this._last_command=void 0,this._last_code=void 0}static get styles(){return L`
      ha-card {
        padding-bottom: 16px;
        position: relative;
        height: 100%;
    ...
    `}},t([He({attribute:!1})],e.AlarmoCard.prototype,"hass",void 0),t([Ie()],e.AlarmoCard.prototype,"_config",void 0),t([Ie()],e.AlarmoCard.prototype,"_alarmoConfig",void 0),t([Ie()],e.AlarmoCard.prototype,"_input",void 0),t([Ie()],e.AlarmoCard.prototype,"warning",void 0),t([Ie()],e.AlarmoCard.prototype,"area_id",void 0),t([Ie()],e.AlarmoCard.prototype,"armOptions",void 0),t([Ie()],e.AlarmoCard.prototype,"readyForArmModes",void 0),t([Ie()],e.AlarmoCard.prototype,"backendConnection",void 0),t([Ie()],e.AlarmoCard.prototype,"showBypassedSensors",void 0),t([Ie()],e.AlarmoCard.prototype,"_menuOpen",void 0),e.AlarmoCard=t([De("alarmo-card")],e.AlarmoCard),window.customCards=window.customCards||[],window.customCards.push({type:"alarmo-card",name:"Alarmo Card",description:"Card for operating Alarmo through Lovelace.",preview:!0}),console.info(`%c  ALARMO-CARD  \n%c  Version: ${"v1.6.9".padEnd(7," ")}`,"color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray"),e}({});
